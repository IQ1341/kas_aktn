<div class="modal fade" id="tambahPenerimaanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="proses_tambah_penerima.php" method="POST">
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="pengurus_id">Pengurus:</label>
